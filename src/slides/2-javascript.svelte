...
<Vertical>
	<Slide>
		<div class="bg-black bg-opacity-30 text-3xl p-3">
			<h1>🔥 Rise of JavaScript Frameworks 🔥</h1>
	...
	<Slide>
		...
		<Notes>
			...
			<p>
				...
				“What needs to be done?” and its value is stored in the todoText
				reference variable. The submit button has a label “Add Todo”.
			</p>
