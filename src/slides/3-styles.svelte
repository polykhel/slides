<script lang="ts">
    ...
    import materialLogo from '@lib/assets/material-logo.png'
...
<!--    <Slide>
    ...
    <Slide animate>
        ...
        <Notes>
            So enter Tailwind CSS. Tailwind takes a more functional approach by
            providing you with utility classes that can be composed together to build
